...
Проект включает стартовую страницу, форму заявки, модальное окно, базовую валидацию и CSS-архитектуру с переменными.
...
GitHub Pages: https://saintssinner.github.io/kr1-html-css-shop/
